...
public class BobAB extends Button {
	...
	public BobAB(Joystick joystick, int axis, double threshold, ThresholdType thresholdType) {
		this.joy = joystick;
		this.axis = axis;
	...
	public BobAB(Joystick joystick, XboxAxis axis, double threshold, ThresholdType thresholdType) {
