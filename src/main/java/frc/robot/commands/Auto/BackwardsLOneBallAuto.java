...
public class BackwardsLOneBallAuto extends SequentialCommandGroup {

  public BackwardsLOneBallAuto(Drivetrain drive, Intake intake, Shooter shoot) {
    super(
      ...
      new ParallelDeadlineGroup( //Ramp up shooter
        new WaitCommand(1.5),                                                        
        new InstantCommand(() -> shoot.shooterSpin( -((Constants.SHOOTER_SPEED / 2.2))), shoot)
      ),
